...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { active: @checkin.active, location_name: @checkin.location_name, user_id: @checkin.user_id }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { active: @checkin.active, location_name: @checkin.location_name, user_id: @checkin.user_id }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
